 ...
 */
	...
	*/
	...
	{
		$this->ikm->Execute ($this->session, 'KNOWLEDGE:'.$this->knw.'.Rebuild',$_col,$_row1,$_row1,$_mode);		 		 
	}		
...
// TABLE xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
	...
	public function tableGetLines($_Instance="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_Instance.'.GET','Lines');	
		return $this->ikm->KMResults;	  		  	 
	}	

	public function tableGetOwner($_Instance="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_Instance.'.GET','Owner');	
		return $this->ikm->KMResults;	  		  	 
	}
	public function tableGetStructure($_Instance="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_Instance.'.GET','Structure');	
		return $this->ikm->KMResults;	  		  	 
	}
	public function tableGetBindexes($_Instance="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_Instance.'.GET','Bindexes');	
		return $this->ikm->KMResults;	  		  	 
	}	
	public function tableGetKindexes($_Instance="wikimaster2")
	{
	...
	public function tableCreate($_tableName)
	{
		$this->ikm->Execute ($this->session , 'TABLE.CREATE',$_tableName);	
		return $this->ikm->KMResults;	  		  	 
	}
	 ...
	 */
	public function tableDelete($_datas,$_table="wikimaster2")
	{
	...
	public function tableUpdate($_rowId,$_datas,$_table="wikimaster2")
	{
	 ...
	 * @return Array
	 */
	public function tableSelect($_mode, $_column, $_operation, $_op1, $_op2="", $_table="wikimaster2")
	{
	 ...
	 * @return Array KMResults
	 */
	public function tableInsert($_data, $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.Insert',$_data);	
		return $this->ikm->KMResults;	  		  	 
	}
	
	public function tableReadBlock($_rowId,$_column, $_position="",$_size="", $_table="wikimaster2")
	{
	 ...
	 * @return Array
	 */
	public function tableReadLine($_rowid, $_data, $_table="wikimaster2")
	{
	 ...
	 * 
	 */
	public function tableReadFirstLine( $_data, $_table="wikimaster2")
	{
	 ...
	 * 
	 */
	public function tableReadNextLine( $_data, $_table="wikimaster2")
	{
 ...
 * @return unknown_type
 */
	public function tableReadContext($_rowid, $_threshold="", $_table="wikimaster2")
	{
 ...
 * @return unknown_type
 */
	public function tableToContext($_rowid, $_table="wikimaster2")
	{
 ...
 * @return unknown_type
 */
	public function tableBIndexCreate($_column, $_unique="", $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.BIndexCreate',$_column, $_unique);	
		return $this->ikm->KMResults;	  		  	 
	}		

	public function tableBIndexDelete($_column, $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.BIndexDelete',$_column);	
		return $this->ikm->KMResults;	  		  	 
	}	
	
	public function tableBIndexRebuild($_column, $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.BIndexRebuild',$_column);	
		return $this->ikm->KMResults;	  		  	 
	}	

	public function tableKIndexCreate($_column, $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.KIndexCreate',$_column);	
		return $this->ikm->KMResults;	  		  	 
	}	
	public function tableKIndexDelete($_column, $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.KIndexDelete',$_column);	
		return $this->ikm->KMResults;	  		  	 
	}		

	public function tableKIndexRebuild($_column, $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.KIndexRebuild',$_column);	
		return $this->ikm->KMResults;	  		  	 
	}	
	
	public function tableKReIndex($_rowid, $_table="wikimaster2")
	{
		$this->ikm->Execute ($this->session , 'TABLE:'.$_table.'.KReIndex',$_rowid);	
		return $this->ikm->KMResults;	  		  	 
	}

	public function tableKUnIndex($_rowid, $_table="wikimaster2")
	{
